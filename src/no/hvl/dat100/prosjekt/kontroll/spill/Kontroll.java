...
public class Kontroll {
	...
	private Spill spill;
	private int nordVinner = 0;
	private int sydVinner = 0;
	...
	public boolean harVinner() {
		...
		if(vinner.equals(Spillere.NORD)) 
		{
			 nordVinner +=1;
		}
		if(vinner.equals(Spillere.SYD)) 
		{
			sydVinner +=1;
		}
	...
	public void spillAuto() {
		...
		System.out.println("Nord antall vunnet. " + nordVinner + " Syd antall vunnet. " +sydVinner);
